...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'loanApplicationSubmitted.create': {
    roles: ['bank-lender', 'loan-officer', 'financial-advisor'],
    key: 'loanApplicationId',
    tenantPath: [],
    userPath: [],
  },
  'propertyListed.create': { roles: ['property-owner'], key: 'propertyListingId', tenantPath: [], userPath: [] },
  'loanApproved.update': {
    roles: ['bank-lender', 'financial-advisor'],
    key: 'loanApprovalId',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['property-owner', 'bank-lender', 'loan-officer', 'financial-advisor', 'end-customer'];
