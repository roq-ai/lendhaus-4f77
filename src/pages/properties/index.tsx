...
export function PropertyListPage(props: PropertyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getProperties({
        ...
        order: params.order,
        searchTermKeys: ['address.contains', 'property_type.contains', 'property_status.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'property_value', header: 'property_value', accessorKey: 'property_value' },
    { id: 'property_type', header: 'Property Type', accessorKey: 'property_type' },
    { id: 'property_status', header: 'Property Status', accessorKey: 'property_status' },
