          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Property Value" text={data?.property_value} />

                <FormListItem label="Property Type" text={data?.property_type} />

                <FormListItem label="Property Status" text={data?.property_status} />
