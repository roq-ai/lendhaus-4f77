...
export function QuoteListPage(props: QuoteListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getQuotes({
        ...
        order: params.order,
        searchTermKeys: ['quote_status.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'quote_amount', header: 'quote_amount', accessorKey: 'quote_amount' },
    { id: 'interest_rate', header: 'interest_rate', accessorKey: 'interest_rate' },
    { id: 'loan_term', header: 'loan_term', accessorKey: 'loan_term' },
    { id: 'quote_status', header: 'Quote Status', accessorKey: 'quote_status' },
