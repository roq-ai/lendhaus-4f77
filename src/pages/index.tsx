...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`lendhaus`}</title>

        <meta
          name="description"
          content="Lendhaus: Empowering property owners with the power to choose. Provide your details, receive loan quotes from various bank lenders, select the best, and proceed with the lender's loan application process. Your financial journey simplified."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1560518883-ce09059eeffa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxwcm9wZXJ0eXxlbnwwfHx8fDE2OTY1Njc1MTd8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Lendhaus: Empowering property owners with the power to choose. Provide your details, receive loan quotes from various bank lenders, select the best, and proceed with the lender's loan application process. Your financial journey simplified.`}
            </Text>
            <Box
