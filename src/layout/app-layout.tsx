...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['property-owner', 'bank-lender', 'loan-officer', 'financial-advisor', 'end-customer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Quotes', path: '/quotes', entity: 'quote', service: AccessServiceEnum.PROJECT, icon: FiFileText },
